...
M.setup_autocmds = function()
  ...
  vim.keymap.set("n", keymaps.current_exercise, exercises.open_current_exercise, { desc = "Current ziglings exercise" })
  ...
  vim.api.nvim_create_user_command("ZiglingsCurrent", exercises.open_current_exercise, { desc = "Go to current exercise" })
